...
public class ContainernScreen2_1 extends AppCompatActivity {
    ...
    public void onClickBack(View view) {
        Intent intent = new Intent(ContainernScreen2_1.this, ContainernScreen1.class);
    ...
    public void onClickNext(View view) {
        ...
        if (contLarge.size() != 0) {
            ...
            Intent intent = new Intent(ContainernScreen2_1.this, ContainernScreen3.class);
